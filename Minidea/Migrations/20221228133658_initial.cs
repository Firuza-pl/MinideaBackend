    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvertismentPlaces", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvertismentPhotos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdvertismentPhotos_AdvertismentPlaces_AdvertismentPlaceId",
                        column: x => x.AdvertismentPlaceId,
                        principalTable: "AdvertismentPlaces",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvertismentPhotos_AdvertismentPlaceId",
                table: "AdvertismentPhotos",
                column: "AdvertismentPlaceId");
