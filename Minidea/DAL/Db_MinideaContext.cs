...
namespace Minidea.DAL
{
    public class Db_MinideaContext : IdentityDbContext<AppUser>
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Data Source=SQL8004.site4now.net;Initial Catalog=db_a92e67_minideadb;User Id=db_a92e67_minideadb_admin;Password=sundanceFaust123!",
